...
public class DrawerDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        leftDrawer.setDirection(DrawerDirection.RIGHT);
        ...
        bottomDrawer.setDirection(DrawerDirection.RIGHT);
        ...
        topDrawer.setDefaultDrawerSize(100);
        topDrawer.setDirection(DrawerDirection.RIGHT);
        topDrawer.setSidePane(topDrawerPane);
        topDrawer.setResizeContent(true);
